...
for s = 1:length(subjects)
    ...
    save(['sub-' subjects{s} '_pSTS_multi_invert_imageFeatures_output.mat'], 'mean_diag_corr', '-v7.3')

    %UPDATED
    save(['beta_sub-' subjects{s} '_pSTS_multi_invert_imageFeatures.mat'], 'b', '-v7.3')
