function fit_encoding_model_supplementary_sensitivity(model,layer,region,dimension)
...
if strcmp(model,'combined') && strcmp(layer,'intermediate')
    save([output_directory filesep 'noise_ceiling' region '_dim' num2str(dimension) 'combined_intermed.mat'], 'mean_diag_corr')
elseif  strcmp(model,'emonet') && strcmp(layer,'intermediate')
    save([output_directory filesep 'noise_ceiling' region '_dim' num2str(dimension) 'emonet_intermed.mat'], 'mean_diag_corr')
elseif  strcmp(model,'emofan') && strcmp(layer,'intermediate')
    save([output_directory filesep 'noise_ceiling' region '_dim' num2str(dimension) 'emofan_intermed.mat'], 'mean_diag_corr')

elseif  strcmp(model,'combined') && strcmp(layer,'late')
    save([output_directory filesep 'noise_ceiling' region '_dim' num2str(dimension) 'combined_late.mat'], 'mean_diag_corr')
elseif  strcmp(model,'emonet') && strcmp(layer,'late')
    save([output_directory filesep 'noise_ceiling' region '_dim' num2str(dimension) 'emonet_late.mat'], 'mean_diag_corr')
elseif  strcmp(model,'emofan') && strcmp(layer,'late')
    save([output_directory filesep 'noise_ceiling' region '_dim' num2str(dimension) 'emofan_late.mat'], 'mean_diag_corr')
