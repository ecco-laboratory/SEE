...
for s = 1:length(subjects)
    ...
    for nd = 10
        ...
        for k=1:5
            ...
            [xl,yl,xs,ys,beta_cv,pctvar] = plsregress(timematched_features(kinds~=k,:), masked_dat.dat(:,kinds~=k)', min(nd,size(masked_dat.dat,1))); %size(masked_dat.dat,1)=252
        ...
        mean_diag_corr(s) = mean(mean(diag_corr))
