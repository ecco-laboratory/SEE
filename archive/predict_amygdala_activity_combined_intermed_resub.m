...
for s = 1:length(subjects)
    ...
    %save(['sub-' subjects{s} '_amygdala_multi_intermed_imageFeatures_output.mat'], 'mean_diag_corr', '-v7.3')

    %UPDATED
    %save(['beta_sub-' subjects{s} '_amygdala_multi_intermed_imageFeatures.mat'], 'b', '-v7.3')

end
save("/home/data/eccolab/Code/NNDb/SEE/amygdala_noise_ceiling_combined_intermed.mat", 'mean_diag_corr', '-v7.3')
