...
for s = 1:length(subjects)
    ...
    for k=1:5 % k-fold cross-validation = 5
        ...
        [xl,yl,xs,ys,beta_cv,pctvar] = plsregress(timematched_features(kinds~=k,:), masked_dat.dat(:,kinds~=k)', 10); %size(masked_dat.dat,1)=252; x to z dimension reduction
...
save("/home/data/eccolab/Code/NNDb/SEE/amygdala_emonet_late_10dims.mat", 'mean_diag_corr', '-v7.3')
