%This is a script that uses features extracted by a specified layer of ANN (EmoNet or EmoFAN) to predict pSTA activity from BOLD data acquired from NNDb
function predict_pSTS_activity(model,layer)
    ...
    for s = 1:length(subjects)
        ...
        save(['sub-' subjects{s} keyword '_pSTS_prediction.mat'], 'mean_diag_corr', '-v7.3')
    
        %UPDATED
        save(['beta_sub-' subjects{s} keyword '_pSTS_prediction.mat'], 'b', '-v7.3')
